    ...
    <div className="w-full">
      ...
      >
        <div className=" relative pt-[50%] sm:pt-[60%] lg:pt-[80%] rounded-t-xl overflow-hidden">
          <img
            className="w-full h-full absolute top-0 start-0 object-cover group-hover:scale-110 transition-transform duration-500 ease-in-out rounded-t-xl"
            src={"/" + props.type + ".png/"}
            alt="Image Description"
          />
        </div>
        <div className="p-4 md:p-5 self-center">
